...
import com.priceking.camera.ShutterButton;
import com.priceking.language.LanguageCodeHelper;
import com.priceking.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements
	...
	private void initOcrEngine(File storageRoot, String languageCode,
		...
		if (ocrEngineModeName.equals("Both")) {
			indeterminateDialog.setMessage("Initializing OCR engine for "
					+ languageName + "...");
		} else {
			indeterminateDialog.setMessage("Initializing OCR engine for "
					+ languageName + "...");
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case OPTIONS_COPY_RECOGNIZED_TEXT_ID:
			...
			returnIntent.putExtra("ocr_result", ocrResultView.getText());
	...
	/**
	 * Sets default values for preferences. To be called the first time this app
	 * is run.
	 */
