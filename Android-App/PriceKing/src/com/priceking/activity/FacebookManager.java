...
public class FacebookManager {
	 ...
	 * 
	 * @param listener
	 *            Callback for status update response
	 * @param message
	 *            Message to post
	 */
	public void updateStatus(final FBResponseListener listener,
	 ...
	 * 
	 * @param listener
	 *            Callback for post comment response
	 * @param postId
	 *            Path to resource in the Facebook graph
	 * @param message
	 *            Comment to post
	 */
	public void postComment(final FBResponseListener listener,
			final String postId, final String message) {
