...
package com.priceking.share.facebook;
...
public class Facebook {
	 ...
	 * access token for use in API requests. In this flow, the user credentials
	 * are handled by Facebook in an embedded WebView, not by the client
	 * application. As such, the dialog makes a network request and renders HTML
	...
	public String request(Bundle parameters) throws MalformedURLException, IOException {
		if (!parameters.containsKey("method")) {
			throw new IllegalArgumentException("API method must be specified. " + "(parameters must contain key \"method\" and value). See"
	...
	public String requestWithUrl(String url) throws FileNotFoundException, MalformedURLException, IOException {
		// Bundle params = new Bundle();

		return Util.openUrl(url, "GET", null);
	}
	...
	public interface FBResponseListener {
