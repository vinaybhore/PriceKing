...
public class FacebookDemoActivity extends Activity implements
		FBResponseListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (facebook.isSessionValid()) {
			...
			new AsyncFacebookRunner(facebook).logout(FacebookDemoActivity.this,
					new RequestListener() {
			...
			facebook.authorize(FacebookDemoActivity.this, APP_ID, PERMISSIONS,
			...
			new Thread() {
				public void run() {
					manager.updateStatus(
							(FBResponseListener) FacebookDemoActivity.this,
							content);
				};
			}.start();
		} else {
	...
	public void responseFailure(int requestCode) {
		Toast.makeText(FacebookDemoActivity.this, "Failed to post...",
	...
	public void responseSuccess(int requestCode, Object result) {
		Looper.prepare();
		Toast.makeText(FacebookDemoActivity.this, "Posted Successfully...",
				Toast.LENGTH_SHORT).show();
