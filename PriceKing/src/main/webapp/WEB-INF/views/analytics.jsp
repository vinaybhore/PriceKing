      ...
      function drawChart() {
    	  $.ajax({
    		  ...
    		  success : function(data) {
    			  var array = [];
    			  array.push(['Products','Coupons','Products']);
    			  console.log(data);

	    		  $.each(data, function(i, obj) {
	    			 array.push([obj.category,obj.couponCount,obj.productCount]);
	    		  });
...
<script type="text/javascript">
    ...
    function drawChart() {
  	  $.ajax({
  		  ...
  		  success : function(data) {
  			  var array = [];
  			  array.push(['Name','Coupons']);
  			  console.log(data);

	    		  $.each(data, function(i, obj) {
	    			 array.push([obj.Name,obj.couponCount]);
	    		  });
  		  
  		  		var view = google.visualization.arrayToDataTable(array);
  		  	 var options = {
  		  	        title: "Coupons per product",
  		  	        width: 600,
  		  	        height: 400,
  		  	        bar: {groupWidth: "95%"},
